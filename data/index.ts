export const navItems = [
    ...
    { name: "Resume", link: "https://drive.google.com/file/d/1cwwOrMTP-i0wjvv74jU7vnEvm5VhdpCa/view?usp=sharing" }
  ];
  ...
  export const gridItems = [
    ...
    },
    {
      id: 3,
      title: "My tech stack",
      description: "Always looking to expand",
      className: "lg:col-span-2 md:col-span-3 md:row-span-2",
      imgClassName: "",
  ...
  export const projects = [
    ...
    {
      id: 4,
      title: "SPARQL-101: Documentation",
      des: "A technical writing sample utilizing Python, SPARQL, Spotify's Web API, and GitHub.",
      img: "/p4.jpg",
      iconLists: [],
      link: "https://github.com/Scurrlin/SPARQL-101",
    },
  ];
